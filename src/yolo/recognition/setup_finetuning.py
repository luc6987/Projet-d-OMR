...
class FinetuningConfig:
    ...
    def __init__(self):
        ...
        self.data_yaml_path = str(self.project_root / 'data' / 'Yolo-Dataset' / 'data.yaml')
        self.source_data_dir = str(self.project_root / 'data' / 'v1.0')
        self.output_dataset_dir = str(self.project_root / 'data' / 'Yolo-Dataset')
        
        # ========== Model related parameters ==========
        self.pretrained_weights = str(self.project_root / 'yolo12l.pt')
        self.resume_weights = str(self.project_root / 'model' / 'yolo' / 'detect' / 'yolo12l_muscima_finetune' / 'weights' / 'last.pt')
        ...
        self.project_dir = str(self.project_root / 'model' / 'yolo' / 'detect')
        self.run_name = 'yolo12l_muscima_finetune'
        self.exist_ok = True
