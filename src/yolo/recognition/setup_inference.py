...
class InferenceConfig:
    ...
    def __init__(self):
        ...
        self.model_path = str(self.project_root / 'model' / 'yolo' / 'detect' / 'yolo12l_muscima_finetune' / 'weights' / 'best.pt')
        
        # ========== Input output parameters ==========
        self.input_image_path = str(self.project_root / 'data' / 'v1.0' / 'data' / 'images' / 'w-01' / 'symbol' / 'p001.png')
