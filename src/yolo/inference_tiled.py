#!/usr/bin/env python3
"""
YOLO12l tiled inference script
...
class TiledInference:
    def __init__(self, model_path: str, tile_size: int = 1216, target_size: int = 640, overlap: int = 100):
        ...
        self.output_dir = project_root / "Output" / "inference_output"
...
def main():
    parser = argparse.ArgumentParser(description='YOLO12l tiled inference script')
...
def inference_from_config(config):
    ...
    from yolo.recognition.setup_inference import InferenceConfig
