"""
MLP models for symbol linking/assembly.
"""
import torch
...
class MLP(torch.nn.Module):
    """Basic MLP for linking symbols using class embeddings."""
...
class MLPwithSoftClass(torch.nn.Module):
    """MLP using soft class probability distributions instead of hard embeddings."""
...
class MLPwithSoftClassExtraMLP(torch.nn.Module):
    """MLP with additional MLP layers for class and bbox embeddings."""
